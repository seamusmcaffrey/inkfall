...
{
    private const float NeonRange = 5f;
    ...
    public void BuildRig()
    {
        ...
        EnsureLight("GreenRim", LightType.Point, new Vector3(0f, -1f, -2f), Quaternion.identity, new Color(0.15f, 1f, 0.4f), 0.6f, RimRange);
        EnsureLight("AmberBottom", LightType.Point, new Vector3(0f, -2.5f, -1.5f), Quaternion.identity, new Color(1f, 0.72f, 0.28f), 0.7f, AmberRange);
        EnsureLight("MagentaMid", LightType.Point, new Vector3(-3.5f, 1f, -1.2f), Quaternion.identity, new Color(0.85f, 0.15f, 0.5f), 0.8f, MidRange);
        EnsureLight("CyanMid", LightType.Point, new Vector3(3.5f, 0.5f, -1.2f), Quaternion.identity, new Color(0.1f, 0.8f, 0.85f), 0.8f, MidRange);
    }
