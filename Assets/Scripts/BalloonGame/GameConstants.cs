...
public static class GameConstants
{
    ...
    /// <summary>Minimum arc peak above launch origin (world units). Ensures every
    /// shot has a visible lob arc, even when targeting the bottom row.</summary>
    ...
    /// <summary>Virtual space below board bottom that the power curve maps through,
    /// creating a shelf where gentle pulls all aim at the bottom row.</summary>
    ...
    // Haptics — slingshot pull tick timing
    /// <summary>Minimum pull strength (normalized 0-1) before ticks start.</summary>
    public const float HAPTIC_PULL_THRESHOLD = 0.15f;
    /// <summary>Tick interval (seconds) at minimum pull — slow, gentle ticks.</summary>
    public const float HAPTIC_TICK_INTERVAL_MIN_PULL = 0.30f;
    /// <summary>Tick interval (seconds) at maximum pull — rapid thumps.</summary>
    public const float HAPTIC_TICK_INTERVAL_MAX_PULL = 0.07f;
    /// <summary>Pull normalized threshold to switch from Light to Medium ticks.</summary>
    public const float HAPTIC_MEDIUM_THRESHOLD = 0.45f;
    /// <summary>Pull normalized threshold to switch from Medium to Heavy ticks.</summary>
